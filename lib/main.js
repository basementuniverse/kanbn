...
module.exports = (() => {
  ...
  return {
     ...
     * @param {?string|?number} sprint The sprint name or number to show stats for, or null for current sprint
     ...
     * @param {string[]} fields A list of fields to sort by, ascending or descending
     */
    async sort(columnName, fields) {
      // TODO kanbn.sort
